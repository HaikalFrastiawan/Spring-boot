...
public class HelloControllerIntegrationTest {
    ...
    @Test
    void helloHaikal() {
        ResponseEntity<String> responseEntity = restTemplate.getForEntity("http://localhost:" + port + "/hello?name=Haikal", String.class);
        String response = responseEntity.getBody();

        Assertions.assertNotNull(response);
        Assertions.assertEquals("Hello Haikal", response.trim());
    }
}